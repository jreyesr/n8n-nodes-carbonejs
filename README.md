...
This node must receive items with a binary property containing a supported document (DOCX, XLSX, PPTX, ODT, ODS, ODP, ODG, HTML, XML, TXT, or CSV). The selected document will be rendered
